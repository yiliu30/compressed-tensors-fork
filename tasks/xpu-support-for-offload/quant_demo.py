...
model_id = "/mnt/data4/yiliu/Qwen/Qwen2-0.5B-Instruct"
...
if _dist.is_available() and _dist.is_initialized():
    _split = get_rank_partition(DATASET_SPLIT, NUM_CALIBRATION_SAMPLES)
else:
    _split = f"{DATASET_SPLIT}[:{NUM_CALIBRATION_SAMPLES}]"
